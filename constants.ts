...
export const DOWNLOAD_PRODUCTS: DownloadProduct[] = [
  ...
  },
  {
    ...
    description: 'A session targeting the habit loop behind snacking and cravings.',
    price: 9.99,
    type: 'audio',
    duration: '30+ min',
    category: 'weight',
  ...
  },
  {
    ...
    description: 'For social anxiety around what others think.',
    price: 9.99,
    type: 'audio',
    duration: '30+ min',
    category: 'anxiety',
  ...
  },
  {
    ...
    description: 'A 17-minute daily mindset session. Try hypnosis for the first time or use it as a regular reset.',
    price: 0,
    type: 'audio',
    duration: '17 min',
    category: 'general',
  ...
  },
  {
    ...
    description: 'A self esteem session for anyone tired of harsh self-talk.',
    price: 9.99,
    type: 'audio',
    duration: '30+ min',
    category: 'anxiety',
  ...
  },
  {
    ...
    description: 'For people who say yes when they mean no. Build assertiveness and hold your ground calmly.',
    price: 9.99,
    type: 'audio',
    duration: '35 min',
    category: 'confidence',
...
export const STOP_SMOKING_FAQS: FAQItem[] = [
  {
    ...
    answer: "Most people can be hypnotised, provided they genuinely want to stop and feel comfortable with the process.",
  },
  {
