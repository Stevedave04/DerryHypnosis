...
export const DOWNLOAD_PRODUCTS: DownloadProduct[] = [
  {
    ...
    duration: '30+ min',
    category: 'weight',
    coverImage: '/images/downloads/junk-food-cravings.webp',
    benefits: [
  ...
  },
  {
    ...
    duration: '30+ min',
    category: 'anxiety',
    coverImage: '/images/downloads/fear-of-judgement.webp',
    benefits: [
  ...
  },
  {
    ...
    type: 'ebook',
    category: 'smoking',
    coverImage: '/images/downloads/smoker-book-cover.webp',
    benefits: [
  ...
  {
    id: 'positive-suggestions',
    payhipCode: 'D13sb',
    title: 'Positive Suggestions & Relaxation',
    subtitle: 'Daily Mindset Hypnosis',
    description: 'Press pause on stress and quiet your mind with this 17-minute foundational session. Tracey\'s voice leads you into deep relaxation, then introduces positive suggestions to boost confidence and reduce daily anxiety.',
    price: 0,
    type: 'audio',
    duration: '17 min',
    category: 'general',
    coverImage: '/images/downloads/positive-suggestions.webp',
    benefits: [
      'Boost confidence and reduce daily anxiety',
  ...
  {
    id: 'quietening-your-inner-critic',
    payhipCode: 'zDqHg',
    title: 'Quietening Your Inner Critic',
    subtitle: 'Silence the harsh inner voice',
    description: 'That relentless voice telling you you\'re not good enough wears you down over time. This guided hypnosis session softens the inner critic and helps you build a calmer, kinder relationship with yourself.',
    price: 9.99,
    type: 'audio',
    duration: '30+ min',
    category: 'anxiety',
    coverImage: '/images/downloads/quietening-your-inner-critic.webp',
    benefits: [
      'Quiet harsh, self-critical thoughts',
      'Build a kinder inner dialogue',
      'Feel calmer and more self-assured',
    ],
    available: true,
  },
  {
    ...
    duration: '30+ min',
    category: 'anxiety',
    coverImage: '/images/downloads/nervous-system-reset.webp',
    benefits: [],
    available: false,
  },
  {
    ...
    subtitle: 'Say no and mean it',
    description: 'You say yes when you want to say no. You give your time away, then resent it later. This guided hypnosis session builds calm, steady assertiveness so you can hold your ground without guilt.',
    price: 9.99,
    type: 'audio',
    duration: '35 min',
    category: 'confidence',
    coverImage: '/images/downloads/the-boundary-shield.webp',
    benefits: [
      'Say no clearly, without guilt or over-explaining',
      'Hold your ground with difficult people',
      'Protect your time and energy naturally',
    ],
    available: true,
  },
  {
    ...
    duration: '30+ min',
    category: 'sleep',
    coverImage: '/images/downloads/deep-sleep-hypnosis.webp',
    benefits: [],
    available: false,
  },
];
